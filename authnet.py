...
def format_response_text(card_number: str, card_expiry_mm: str, card_expiry_yy: str, card_cvc: str, result: dict, execution_time: float) -> str:
    ...
    response_text += f"<a href='https://t.me/Amkuushu'>㊕</a> <b>CC ⇾</b> <code>{cc_display}</code>\n"
    response_text += f"<a href='https://t.me/Amkuushu'>㊕</a> <b>Gateway ⇾</b> Authnet-14.95$\n"
    response_text += f"<a href='https://t.me/Amkuushu'>㊕</a> <b>Response ⇾</b> {error_message}\n\n"
    ...
    if bin_info:
        ...
        response_text += f"<a href='https://t.me/Amkuushu'>㊕</a> <b>BIN Info:</b> {vendor} - {card_type} - {level}\n"
        response_text += f"<a href='https://t.me/Amkuushu'>㊕</a> <b>Bank:</b> {bin_info.get('bank_name', 'N/A')}\n"
        response_text += f"<a href='https://t.me/Amkuushu'>㊕</a> <b>Country:</b> {bin_info.get('country', 'N/A')} {bin_info.get('flag', '')}\n\n"

    response_text += f"<a href='https://t.me/Amkuushu'>㊕</a> <b>Took {execution_time:.2f} seconds</b>"
